...
type UserCourseServiceClient interface {
	...
	GetUserCourse(ctx context.Context, in *ById, opts ...grpc.CallOption) (*UserCourseGetRes, error)
...
func (c *userCourseServiceClient) GetUserCourse(ctx context.Context, in *ById, opts ...grpc.CallOption) (*UserCourseGetRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserCourseGetRes)
...
type UserCourseServiceServer interface {
	...
	GetUserCourse(context.Context, *ById) (*UserCourseGetRes, error)
...
func (UnimplementedUserCourseServiceServer) GetUserCourse(context.Context, *ById) (*UserCourseGetRes, error) {

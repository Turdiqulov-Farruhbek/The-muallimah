...
func NewGin(h *handlers.Handler) *gin.Engine {
    ...
    //     evalution.PUT("/update/:id", h.UpdateEvaluation)
    ...
    //     transactions.PUT("/update/:id", h.UpdateTransaction)
    //     transactions.DELETE("/delete/:id", h.DeleteTransaction)
	...
	// {
	// 	usercourses.POST("/create", h.CreateUserCourse)

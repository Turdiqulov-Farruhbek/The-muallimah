...
-- -- Assuming users pre-purchase credits and then use those to "buy" courses
-- INSERT INTO transactions (user_id, amount, type) VALUES
-- ((SELECT id FROM users WHERE email = 'john.doe@example.com'), 100.00, 'credit'),
-- ((SELECT id FROM users WHERE email = 'jane.smith@example.com'), 50.00, 'credit'),
-- ((SELECT id FROM users WHERE email = 'john.doe@example.com'), 49.99, 'debit'), -- John buys "Introduction to Python"
-- ((SELECT id FROM users WHERE email = 'jane.smith@example.com'), 79.99, 'debit'); -- Jane buys "Machine Learning Fundamentals"

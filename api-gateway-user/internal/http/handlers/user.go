...
// @Param          dob_from        query   string  false  "Date of birth from"
// @Param          dob_to          query   string  false  "Date of birth to"
// @Param          phone_number    query   string  false  "Phone number"
// @Param          email           query   string  false  "Email"
// @Param          occupation      query   string  false  "Occupation"
// @Param          address         query   string  false  "Address"
// @Param          gender          query   string  false  "Gender"
// @Param          limit           query   int64   false  "Pagination limit"
// @Param          offset          query   int64   false  "Pagination offset"
...
func (h *Handler) ListUsers(c *gin.Context) {
	...
	req.Body.FirstName = c.Query("first_name")
	req.Body.LastName = c.Query("last_name")
	req.Body.DobFrom = c.Query("dob_from")
	req.Body.DobTo = c.Query("dob_to")
	req.Body.PhoneNumber = c.Query("phone_number")
	req.Body.Email = c.Query("email")
	req.Body.Occupation = c.Query("occupation")
	req.Body.Address = c.Query("address")
	req.Body.Gender = c.Query("gender")

...
type UserLessonServiceClient interface {
	...
	GetUserLesson(ctx context.Context, in *ById, opts ...grpc.CallOption) (*UserLesson, error)
	UpdateUserLesson(ctx context.Context, in *UserLessonUpdateReq, opts ...grpc.CallOption) (*Void, error)
	DeleteUserLesson(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error)
...
func (c *userLessonServiceClient) GetUserLesson(ctx context.Context, in *ById, opts ...grpc.CallOption) (*UserLesson, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserLesson)
...
func (c *userLessonServiceClient) DeleteUserLesson(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
...
type UserLessonServiceServer interface {
	...
	GetUserLesson(context.Context, *ById) (*UserLesson, error)
	UpdateUserLesson(context.Context, *UserLessonUpdateReq) (*Void, error)
	DeleteUserLesson(context.Context, *ById) (*Void, error)
...
func (UnimplementedUserLessonServiceServer) GetUserLesson(context.Context, *ById) (*UserLesson, error) {
...
func (UnimplementedUserLessonServiceServer) DeleteUserLesson(context.Context, *ById) (*Void, error) {
...
func _UserLessonService_GetUserLesson_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserLessonServiceServer).GetUserLesson(ctx, req.(*ById))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserLessonService_DeleteUserLesson_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserLessonServiceServer).DeleteUserLesson(ctx, req.(*ById))
	}
	return interceptor(ctx, in, info, handler)
}
